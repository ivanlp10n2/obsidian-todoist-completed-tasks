...
import { buildRenderText2 } from 'src/constants/formatTasks';
...
describe("formatTasks", () => {
	describe("prepareTasksForRendering", () => {
		it("should format tasks for rendering", () => {
			...
			console.log("actual result:", renderedTasks)
			console.log("expected result:", expectedPrepareTaskForRenderingOutput)
